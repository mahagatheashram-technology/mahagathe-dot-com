...
export function DonationModal({ isOpen, onClose, campaignTitle, programTag }: DonationModalProps) {
            ...
            <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden animate-fade-in max-h-[90vh] overflow-y-auto">
                ...
                <div className="sticky top-0 z-10 bg-gradient-to-r from-[var(--brand-rose-500)] to-[var(--brand-maroon-900)] px-6 py-5 text-white">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-xl font-serif font-bold">Support Our Cause</h2>
                            {campaignTitle && (
                ...
                <div className="p-6">
                    ...
                    <div className="flex items-center gap-4 mb-5">
                        ...
                        <span className="text-sm text-[var(--neutral-500)]">or enter amount</span>
                        <div className="flex-1 h-px bg-[var(--neutral-200)]" />
                    </div>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={(e) => handleCustomerInfoChange("phone", e.target.value.replace(/\D/g, "").slice(0, 10))}
