                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
                    ...
                    <div className="lg:col-span-7 flex flex-col h-full">
                        ...
                        <div className="space-y-4 flex-grow">
                            <h3 className="text-2xl md:text-3xl font-serif font-bold text-[var(--brand-maroon-900)]">{campaign.title}</h3>
                    ...
                    <div className="lg:col-span-5 h-full">
                        <div className="bg-white rounded-3xl p-8 md:p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-[var(--neutral-100)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-shadow duration-300 h-full flex flex-col justify-evenly">
                            <div className="space-y-8">
                                {/* Raised Amount */}
                                <div>
                                    <div className="text-[var(--brand-rose-500)] font-bold tracking-wider text-xs uppercase mb-2">Raised Amount</div>
                                ...
                                <div className="grid grid-cols-2 gap-8 py-6 border-t border-b border-[var(--neutral-100)]">
                                    <div>
                                        <div className="text-[var(--brand-rose-500)] font-bold tracking-wider text-xs uppercase mb-2">Days Left</div>
                                        <div className="text-3xl font-bold text-[var(--neutral-900)]">{campaign.daysLeft}</div>
                                    </div>
                                    <div>
                                        <div className="text-[var(--brand-rose-500)] font-bold tracking-wider text-xs uppercase mb-2">Total Funders</div>
                                        <div className="text-3xl font-bold text-[var(--neutral-900)]">{campaign.funders}</div>
                                    </div>
                                </div>
