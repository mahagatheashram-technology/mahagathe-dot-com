        ...
        <div className="relative w-full h-[500px] md:h-[600px] flex items-center justify-center">
            ...
            >
                ...
                <path
                    ...
                    strokeWidth="3"
                    fill="none"
                    className={cn("transition-all duration-500", activeIndex === 0 ? "opacity-60 stroke-[4px]" : "opacity-20")}
                />
                {/* Branch 2 (Top Right) */}
                <path
                    ...
                    strokeWidth="3"
                    fill="none"
                    className={cn("transition-all duration-500", activeIndex === 1 ? "opacity-60 stroke-[4px]" : "opacity-20")}
                />
                ...
                <path
                    ...
                    strokeWidth="3"
                    fill="none"
                    className={cn("transition-all duration-500", activeIndex === 2 ? "opacity-60 stroke-[4px]" : "opacity-20")}
                />
                ...
                <path
                    ...
                    strokeWidth="3"
                    fill="none"
                    className={cn("transition-all duration-500", activeIndex === 3 ? "opacity-60 stroke-[4px]" : "opacity-20")}
                />
            </svg>
